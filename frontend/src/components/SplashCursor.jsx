...
function SplashCursor({
  ...
  // keep authRef current without restarting the heavy effect
  useEffect(() => {
    authRef.current = isAuthenticated;
    // if user logged out, resume animation
    if (!isAuthenticated && startRef.current) startRef.current();
  }, [isAuthenticated]);

  // keep pausedRef in sync with prop changes
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    function createProgram(vertexShader, fragmentShader) {
      ...
      if (!gl.getProgramParameter(program, gl.LINK_STATUS)) { /* program linking failed; suppressed in production */ }
      return program;
    }
    ...
    function compileShader(type, source, keywords) {
      ...
      if (!gl.getShaderParameter(shader, gl.COMPILE_STATUS)) { /* shader compile failed; suppressed in production */ }
      return shader;
    }
